...
const Payment = (props) => {
    ...
    return(
        <div>
            ...
            <div style={{fontWeight:"600",fontSize: "20px",marginLeft:"25px",marginTop:"25px"}}>From: {props.formDetails.source}</div>
            <div style={{fontWeight:"600",fontSize: "20px",marginLeft:"25px",marginTop:"25px"}}>To: {props.formDetails.destination}</div>
