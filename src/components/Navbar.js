    ...
    return(
        <nav className={styles.navbar}>
            <ul className={styles["navbar-nav"]}>
                ...
                <Link style={props.selected === 'home' ? {color: '#4535be',textDecoration:"underline"} : {color: '#908cb6'}} className={styles["nav-link"]}>HOME</Link>
                </li>
                <li className={styles["nav-item"]}>
                <Link style={props.selected === 'stations' ? {color: '#4535be',textDecoration:"underline"} : {color: '#908cb6'}} className={styles["nav-link"]}>STATIONS</Link>
                </li>
                <li className={styles["nav-item"]}>
